import 'package:blog_skanifo/models/article_nasional.dart';
import 'package:blog_skanifo/widget/image_container.dart';
import 'package:flutter/material.dart';

import '../widget/custom_tag.dart';

class nasional_article extends StatelessWidget {
  const nasional_article({super.key});
  static const routeName = '/nasional_article';

  @override
  Widget build(BuildContext context) {
    final article = ModalRoute.of(context)!.settings.arguments as Nasional;
